...
public class PathUtils {
	...
	public static String getJunitPath() {
		return System.getProperty("user.dir")+"/target/libs/junit-4.12.jar";
	}
	
	private static String getHamcrestPath() {
		return System.getProperty("user.dir")+"/target/libs/hamcrest-all-1.3.jar";
	}
